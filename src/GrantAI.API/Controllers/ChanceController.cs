...
public sealed class ChanceController : ControllerBase
{
    ...
    public ChanceController(ISpecialtyQueryService specialties) => _specialties = specialties;

    /// <summary>
    /// Estimates the probability that a participant clears the entrance threshold
    /// for the group, derived from the forecasted pass rate, with a range and the
    /// factors behind it.
    /// </summary>
